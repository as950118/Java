...
%>
	...
	<div class="container" style="padding-top:30px;">
		<div class="row">
			...
			<a href="bbs.jsp" class="btn btn-xs btn-default">목록</a>
			<%
				if(userID != null && userID.equals(bbs.getUserID())){
				
			%>
				<a href="update.jsp?bbsID=<%= bbsID %>" class="btn btn-primary btn-xs pull-right">수정</a>
				<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%=bbsID %>" class="btn btn-danger btn-xs pull-right">삭제</a>
			<%
				}
			%>
		</div>
